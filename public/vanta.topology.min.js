!function (e, t) {
    ...
    r.VantaBase = class {
        constructor(e = {}) {
            ...
            if (this.options = Object.assign({
                ...
                scale: 1,
                scaleMobile: 1
            }, t), (e instanceof HTMLElement || "string" == typeof e) && (e = {el: e}), Object.assign(this.options, e), this.options.THREE && (n = this.options.THREE), this.el = this.options.el, null == this.el) h('Instance needs "el" param!'); else if (!(this.options.el instanceof HTMLElement)) {
                const e = this.el;
        ...
        windowMouseMoveWrapper(e) {
            ...
            if (!t) return !1;
            const s = e.clientX - t.left, i = e.clientY - t.top;
        ...
        windowTouchWrapper(e) {
            ...
            if (1 === e.touches.length) {
                const s = e.touches[0].clientX - t.left, i = e.touches[0].clientY - t.top;
                s >= 0 && i >= 0 && s <= t.width && i <= t.height && (this.mouseX = s, this.mouseY = i, this.options.mouseEase || this.triggerMouseMove(s, i))
            }
        }
        ...
        windowGyroWrapper(e) {
            const t = this.getCanvasRect();
            if (!t) return !1;
            const s = Math.round(2 * e.alpha) - t.left, i = Math.round(2 * e.beta) - t.top;
            s >= 0 && i >= 0 && s <= t.width && i <= t.height && (this.mouseX = s, this.mouseY = i, this.options.mouseEase || this.triggerMouseMove(s, i))
        }
        ...
        triggerMouseMove(e, t) {
            ...
            const s = e / this.width, i = t / this.height;
    ...
    class d extends p {
        ...
        onInit() {
            const e = this;
            new l((function (t) {
                let i = e.width, o = e.height, n = (i + 200) / 10, r = (o + 200) / 10, h = [], a = [], c = 0;

                function p(e, s, i) {
                    let o = 0, n = 1, r = t.createVector(0, 0), h = t.createVector(0, 0);
                    for (let a = 0; a < 100; a++) {
                        let c = a / 100 * t.TAU, p = t.createVector(e + t.cos(c) * i, s + t.sin(c) * i),
                            l = t.noise(p.x, p.y);
                ...
                t.setup = function () {
                    e.initP5(t), t.smooth(), t.noStroke(), function () {
                        for (let e = 0; e < 4500; e++) {
                            let s = t.random(t.width + 200), i = t.random(t.height + 200);
                            a.push({
                    ...
                    t.translate(-100, -100), function () {
                        ...
                        t.strokeWeight(1), t.stroke(((e, t = 1) => {
                            const i = s(e), o = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(i),
